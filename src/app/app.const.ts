...
export const CONSTANTS = {
  ...
  API_URL: {
    ...
    opportunity: {
      ...
      getById : "/opportunity/getOpportunityInfoById",
      getCustomerBizByBizId: "/opportunity/getCustomerBizByBizId",
      save: "/opportunity/save"
    },
    industry:{
      list: "/industry/list",
      listBusinessScopeByIndustryCode:"/industry/listBusinessScopeByIndustryCode",
      listPermitByScopeCode:"/industry/listPermitByScopeCode",
      listDictionaryByCondition:"/industry/listDictionaryByCondition"
    },
    contract:{
      listNewHostCompany: "/contract/listNewHostCompany"
    },
    contact:{
      listContactByCustomerId: "/contact/listContactByCustomerId"
    },
    park:{
      list: "/park/list"
    },
